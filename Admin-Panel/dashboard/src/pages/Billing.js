...
function Billing() {
  ...
  const getData = () => {
    axios("http://localhost:7000/payments").then(async (res) => {
      ...
      <Row gutter={[24, 0]}>
        <Col span={24} md={16} className="mb-24">
          ...
          >
            <Row gutter={[24, 24]}>
              {information.map((get) => (
                <Col span={24} key={get._id}>
                  <Card className="card-billing-info" bordered="false">
                    <div className="col-info">
                      <Descriptions title="Payments">
                        <Descriptions.Item label="Sender Name" span={3}>
                          {get.senderName}
                        </Descriptions.Item>

                        <Descriptions.Item label="Reciever Name" span={3}>
                          {get.recieverName}
                        </Descriptions.Item>
                        <Descriptions.Item label="Payment Type" span={3}>
                          {get.paymentType}
                        </Descriptions.Item>
